        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <div class="card" >
                    ...
                    <div class="overlay">
                        <div class="text"><h5>Neilson is a Boston native that graduated with honors from the Sawyer Businesschool at Suffolk University, majored in global businessand management. He is also a certified ESL (English as Second Language) instructor.</h5>
                        </div>
                    </div>
